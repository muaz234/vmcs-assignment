				...
				<table id="products" class="table table-bordered">
					...
					<?php 
						while($row = mysqli_fetch_array($result)) {
							...
							<th style="width: 400px;  text-transform: uppercase;">NUMBER OF CANS '. $row['name'] .'</th>
							<th><input id='. $row['id'] .' value = '. $row['quantity'] .' type="number" min="0" max="20"class="form-control drink"></th>
